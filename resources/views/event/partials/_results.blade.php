            ...
            <div class="flex justify-between mb-3">
                ...
                <div>
                    @if(auth()->user()->isEventHost($event->id))
                        <inv-button link="{{ route('event.edit', ['id' => $event->id])}}"
                                    color="bg-yellow-lightest leading-none text-red-darkest border-2 border-red-darkest hover:bg-yellow-lighter font-semibold text-sm p-2 m-0">
